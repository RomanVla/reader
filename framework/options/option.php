	...
	'menus' => array(
			...
			'menus' => array(
				...
				array(
					...
					'controls' => array(
                        ...
                        array(
                            'label' => __('Header Font Family url', 'reader'),
                            'description' => __('Enter the url of the Google font you want for header font. ej: http:&#47;&#47;fonts.googleapis.com/css?family=Roboto:400,300,600,700', 'reader'),
                            'name'=>'font_family_url2',
                            'type' => 'textbox',
                            'default' => "https://fonts.googleapis.com/css?family=Rajdhani:400,500,600,700,300"
                        ),array(
                            'label' => __('Header Font Family name', 'reader'),
                            'description' => __('Enter the declaration (name) of your google font for header font.', 'reader'),
						...
						array(
							'label' => __('Body Font Family url', 'reader'),
							'description' => __('Enter the url of the Google font you want for body. ej: http:&#47;&#47;fonts.googleapis.com/css?family=Roboto:400,300,600,700', 'reader'),
							'name'=>'font_family_url1',
							'type' => 'textbox',
							'default' => "http://fonts.googleapis.com/css?family=Raleway:400,100,200,300,500,600,700"
						),array(
							'label' => __('Body Font Family name', 'reader'),
		...
		array(
			...
			'controls' => array(
                ...
                array(
                    'name'      => 'select-layout',
                    'label'     => __('Select Layout', 'reader'),
                    'type' => 'select',
                    'description' => __('Select Blog Layout', 'reader'),
                    'items' => array(
                        array(
                            'value' => 'container-fluid',
                            'label' => __('Full width', 'reader'),
                        ),array(
                            'value' => 'container',
                            'label' => __('Box', 'reader'),
                        ),
                ...
                array(
                    'name'      => 'select-style',
                    'label'     => __('Select Style', 'reader'),
                    'type'      => 'select',
                    'description' => __('Select Blog Style', 'reader'),
                    'items' => array(
                        array(
                            'value' => 'style-1',
                            'label' => __('Style 1', 'reader'),
                        ),array(
                            'value' => 'style-2',
                            'label' => __('Style 2', 'reader'),
                        ),
                    ),
                    'default' => array(
                        'style-1',
